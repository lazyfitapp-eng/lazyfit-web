...
const THREE_DAY_TEMPLATE = [
  {
    ...
    exercises: [
      ...
      { exercise_name: 'Incline Dumbbell Press',  sets_target: 3, reps_min: 6,  reps_max: 10, rest_seconds: 150, exercise_order: 3 },
      { exercise_name: 'Cable Row',               sets_target: 3, reps_min: 8,  reps_max: 12, rest_seconds: 120, exercise_order: 4 },
      { exercise_name: 'Lateral Raise',           sets_target: 3, reps_min: 10, reps_max: 12, rest_seconds: 90,  exercise_order: 5 },
      { exercise_name: 'Tricep Pushdown',         sets_target: 3, reps_min: 8,  reps_max: 12, rest_seconds: 90,  exercise_order: 6 },
    ],
  },
  {
    name: 'Lower',
    exercises: [
      { exercise_name: 'Calf Raise',            sets_target: 4, reps_min: 8,  reps_max: 12, rest_seconds: 90,  exercise_order: 1 },
      { exercise_name: 'Bulgarian Split Squat', sets_target: 3, reps_min: 6,  reps_max: 10, rest_seconds: 180, exercise_order: 2 },
      { exercise_name: 'Pendulum Squat',        sets_target: 3, reps_min: 6,  reps_max: 10, rest_seconds: 150, exercise_order: 3 },
      { exercise_name: 'Leg Extension',         sets_target: 3, reps_min: 8,  reps_max: 12, rest_seconds: 120, exercise_order: 4 },
      { exercise_name: 'Lying Leg Curl',        sets_target: 3, reps_min: 8,  reps_max: 12, rest_seconds: 120, exercise_order: 5 },
      { exercise_name: 'Hip Thrust',            sets_target: 3, reps_min: 8,  reps_max: 12, rest_seconds: 150, exercise_order: 6 },
    ],
  },
  {
    name: 'Upper B',
    exercises: [
      ...
      { exercise_name: 'Dumbbell Shoulder Press', sets_target: 3, reps_min: 6,  reps_max: 10, rest_seconds: 150, exercise_order: 3 },
      { exercise_name: 'Face Pull',               sets_target: 3, reps_min: 10, reps_max: 12, rest_seconds: 90,  exercise_order: 4 },
      { exercise_name: 'Bicep Curl',              sets_target: 3, reps_min: 8,  reps_max: 12, rest_seconds: 90,  exercise_order: 5 },
      { exercise_name: 'Skull Crusher',           sets_target: 3, reps_min: 8,  reps_max: 12, rest_seconds: 90,  exercise_order: 6 },
    ],
  },
]
